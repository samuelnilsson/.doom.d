...
(use-package! gptel
  ...
  (defun gptel-for-readme-gh ()
    (setq-local gptel-backend (gptel-get-backend "Copilot"))
    (setq-local gptel-model 'gemini-3-pro-preview)
    (setq-local gptel-system
                "You are a crisp technical writer. Output clean Markdown with short sections, bullet lists, and examples. Prefer active voice."))
  
  (defun gptel-for-org-gh ()
    (setq-local gptel-backend (gptel-get-backend "Copilot"))
    (setq-local gptel-model 'gemini-3-pro-preview)
    (setq-local gptel-system
                "You are a crisp technical writer. Output clean Markdown with short sections, bullet lists, and examples. Prefer active voice."))
  
  (defun gptel-for-programming-gh ()
    (setq-local gptel-backend (gptel-get-backend "Copilot"))
    (setq-local gptel-model 'gemini-3-pro-preview)
    (setq-local gptel-system
                "You are a careful programmer. Show minimal runnable code with comments. Note assumptions, complexity, and edge cases. Provide tests when useful."))

  :hook ((prog-mode . gptel-for-programming-gh)
         (markdown-mode . gptel-for-readme-gh)
         (org-mode . gptel-for-readme-gh))
  :config
...
(use-package! gptel-magit
  ...
  :config (setq gptel-magit-model 'gemini-3-flash-preview
                gptel-magit-backend (gptel-get-backend "Copilot")))
#+end_src
