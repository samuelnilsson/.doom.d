...
Use gptel to interact with llama-swap language models.
...
(use-package! gptel
  ...
  (defun gptel-for-text ()
    ...
    (if (string-equal (getenv "DOOM_GPTEL_MAC") "t")
        (setq-local gptel-model 'qwen3.5-35b))
...
(use-package! gptel-magit
  ...
  (if (string-equal (getenv "DOOM_GPTEL_MAC") "t")
        (setq gptel-magit-model 'qwen3.5-9b))
  (if (string-equal (getenv "DOOM_GPTEL_HOME") "t")
        (setq gptel-magit-model 'qwen3.5-4b)))
#+end_src
